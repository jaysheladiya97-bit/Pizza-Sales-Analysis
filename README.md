...
- **SQLQuery1.sql**  
  SQL queries used to calculate KPIs and perform data analysis.

- **PIZZA SALES SQL QUERIES.docx**  
  Document explaining SQL queries and analysis logic.

- **Final.xlsx**  
  Excel dashboard showcasing visual insights and summarized results.
...
- Delivered a clear sales performance overview using KPIs  
...
- Dashboard creation and business reporting using Excel  
